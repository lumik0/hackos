...
local repositoryURL = "https://raw.githubusercontent.com/lumik0/hackos/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/HackOS installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "HackOS")
...
local installerMenu = menu:addContextMenuItem("HackOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("HackOS HDD")
	end
	...
	component.invoke(EEPROMAddress, "setLabel", "HackOS EFI")
